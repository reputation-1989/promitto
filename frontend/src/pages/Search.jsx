...
import { Search as SearchIcon, ArrowLeft, Send, User, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="relative z-10 backdrop-premium border-b border-border sticky top-0">
        <div className="max-w-5xl mx-auto px-6 h-20 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-text-tertiary">Search by username only</p>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-8">
        {/* Privacy Notice */}
        <Card>
          <div className="flex items-start gap-4 p-6 bg-accent-purple/5 border border-accent-purple/20 rounded-xl">
            <div className="w-10 h-10 rounded-xl bg-accent-purple/10 flex items-center justify-center flex-shrink-0">
              <Lock className="w-5 h-5 text-accent-purple" strokeWidth={2} />
            </div>
            <div className="flex-1">
              <h3 className="font-semibold text-sm mb-1">Privacy First</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                Promitto is exclusive and private. To protect everyone's privacy, you can only search by exact username. 
                Profile details are revealed only after connecting.
              </p>
            </div>
          </div>
        </Card>
          ...
          <form onSubmit={handleSearch} className="space-y-5">
            <div>
              ...
              <p className="text-xs text-text-quaternary mt-2">
                You need to know their exact username to connect
              </p>
            </div>
            <Button 
              type="submit" 
                ...
                <div className="text-center space-y-8 py-8">
                  ...
                  <div className="max-w-md mx-auto">
                    <div className="flex items-start gap-3 p-4 bg-bg-subtle/50 border border-border rounded-xl text-left">
                      ...
                      <p className="text-xs text-text-secondary leading-relaxed">
                        Their full profile will be visible after you connect. Promitto keeps things private and exclusive.
                      </p>
                    </div>
                  </div>
                  <Button 
          ...
          {!loading && !searchResult && searched && (
            ...
            >
              <EmptyState 
                ...
                description="Try searching with the exact username"
              />
            </motion.div>
          )}
        </AnimatePresence>
